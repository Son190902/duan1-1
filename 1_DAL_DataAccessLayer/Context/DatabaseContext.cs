...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-VCVS03AO\\SQLEXPRESS;Initial Catalog=DUAN1QLNT;Persist Security Info=True;User ID=dungna29;Password=123");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Chatlieu>(entity =>
            {
                entity.HasKey(e => e.Macl)
                    .HasName("PK__Chatlieu__7A21F8424A5B4D0D");
            ...
            modelBuilder.Entity<Chitiethoadon>(entity =>
            {
                entity.HasKey(e => e.MaCtdh)
                    .HasName("PK__Chitieth__FD2652FE4577F363");
            ...
            modelBuilder.Entity<Ctsanpham>(entity =>
            {
                entity.HasKey(e => e.Mactsanpham)
                    .HasName("PK__CTsanpha__6C4113C2BFB02BF2");
            ...
            modelBuilder.Entity<Dichvu>(entity =>
            {
                entity.HasKey(e => e.Madichvu)
                    .HasName("PK__Dichvu__7EA7308E0D5B24EA");
            ...
            modelBuilder.Entity<Donvi>(entity =>
            {
                entity.HasKey(e => e.Madv)
                    .HasName("PK__Donvi__7A21E029AEA399E8");
            ...
            modelBuilder.Entity<Hinhanh>(entity =>
            {
                entity.HasKey(e => e.Mahh)
                    .HasName("PK__Hinhanh__7A2100A21971148F");
            ...
            modelBuilder.Entity<Hoadon>(entity =>
            {
                entity.HasKey(e => e.Mahoadon)
                    .HasName("PK__Hoadon__8C708E0C517783B1");
            ...
            modelBuilder.Entity<Khachhang>(entity =>
            {
                entity.HasKey(e => e.Makhach)
                    .HasName("PK__Khachhan__98E32F1543000D64");
            ...
            modelBuilder.Entity<Loaidichvu>(entity =>
            {
                entity.HasKey(e => e.Maloaidichvu)
                    .HasName("PK__Loaidich__A8195710CA48840C");
            ...
            modelBuilder.Entity<Loaisanpham>(entity =>
            {
                entity.HasKey(e => e.Maloaisp)
                    .HasName("PK__Loaisanp__F57B12AE192E0D35");
            ...
            modelBuilder.Entity<Mausac>(entity =>
            {
                entity.HasKey(e => e.Mams)
                    .HasName("PK__Mausac__7A21CB83D28A7911");
            ...
            modelBuilder.Entity<Nhanvien>(entity =>
            {
                entity.HasKey(e => e.Manhanvien)
                    .HasName("PK__Nhanvien__75A28B52E83CA74C");
            ...
            modelBuilder.Entity<Sanpham>(entity =>
            {
                entity.HasKey(e => e.Masanpham)
                    .HasName("PK__Sanpham__8F121B2F10506A16");
            ...
            modelBuilder.Entity<Thanhtoan>(entity =>
            {
                entity.HasKey(e => e.Mathanhtoan)
                    .HasName("PK__Thanhtoa__8C448CA506D70644");
